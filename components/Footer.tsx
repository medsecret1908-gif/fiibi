      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 text-center md:text-left">
          <div className="flex flex-col md:flex-row justify-center md:justify-start gap-4 md:gap-8 text-sm">
            <a href="#" className="text-[#9b844b] hover:text-[#1c170d] transition-colors">{dictionary.footer.imprint}</a>
            <a href="#" className="text-[#9b844b] hover:text-[#1c170d] transition-colors">{dictionary.footer.privacy}</a>
            <a href="#" className="text-[#9b844b] hover:text-[#1c170d] transition-colors">{dictionary.footer.terms}</a>
          </div>
        </div>
      </div>
    </footer>
